...
<div className='listbutton '>
                ...
                >
 <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none"style={{ transition: 'transform 0.5s, filter 0.5s', transform: clickedCompId === company.id ? 'rotate(-180deg)' : 'rotate(0deg)',}} onClick={() => this.handleBrandClick(company.id)}>
