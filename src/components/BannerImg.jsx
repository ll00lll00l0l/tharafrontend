        ...
        <div className="ban">
          <div className="banner  ">
            <div className="banner-info">
              ...
              >
                <path
                  d="M1.00348 4.14711C91.023 -2.29866 274.675 5.5266 307.275 3.64351C311.744 3.38536 92.2367 0.0132731 82.0725 20.0314"
                  stroke="#B859FF"
                  strokeWidth="3"
                />
              </svg>
              ...
              <p>
                Thara is a leading FMCG distributor and importer/exporter with
                over 40 years of experience. We specialize in fast-moving
                consumer goods, including confectioners, biscuits, chocolates,
                and instant noodles.
              </p>
          ...
          <div className="banner-container ">
            <div className="banner-image-container">
              ...
              <img
                className="Ellipse-image img-fluid "
                src={Ellipse}
                alt="img"
              />
