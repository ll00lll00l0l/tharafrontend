      ...
      <div className="listbroder">
        <div className="aligm">
          {companies.map((company) => {
            ...
            const imagePathWithoutBaseURL = company.image.replace(
              "https://0.0.0.0:9090",
              newBaseURL
            );
            ...
            return (
              <div
                key={company.id}
                className="border-bottom rounded-sm p-3 pt-6"
              >
                {company.image && (
                  <img
                  ...
                  <div id={`collapse${company.id}`} className=" collapse">
                    <div className="row listrow">
                      <div className="listcol col-md-6">
                        ...
                        <p>
                          <img className="" src={Email} alt="img" />{" "}
                          ...
                          .map((filteredbrand) => (
                            <div key={filteredbrand.id} className="">
                              {filteredbrand.image &&
                                (() => {
                                  const newBaseURL = `${baseURL}`;
                                  const imagePathWithoutBaseURL =
                                    filteredbrand.image.replace(
                                      "https://0.0.0.0:9090",
                                      newBaseURL
                                    );
